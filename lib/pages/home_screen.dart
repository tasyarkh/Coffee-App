...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Widget itemCoffee({images, title, subTitle, price, rate}) {
    return Container(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Icon(Icons.star, size: 12, color: Styling.primaryColor),
                Text(
                  "$rate",
                  style:
                      TextStyle(color: Colors.white, fontWeight: Styling.bold),
                )
              ],
            ),
          )
